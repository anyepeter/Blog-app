...
RSpec.describe 'Posts', type: :system do
  describe 'check the content of the index page' do
    before(:each) do
      ...
      @post_one = Post.create(author: @user, Title: 'Vue', Text: 'this is my first post', CommentsCounter: 2,
                              LikesCounter: 0)
      @post_two = Post.create(author: @user, Title: 'React', Text: 'I am gonna get a jon in may', CommentsCounter: 0,
                              LikesCounter: 0)
    ...
    it 'User should see the post title' do
      expect(page).to have_content(@post_one.Title.to_s)
      expect(page).to have_content(@post_two.Title.to_s)
    end
