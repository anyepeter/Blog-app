  ...
  describe 'check the content of the index page' do 
   before(:each) do
    @user_one = User.create(name: 'Chendi',
     photo: 'https://play-lh.googleusercontent.com/UjaAdTYsArv7zAJbqGWjQw2ftuOtnAlvokffC3TQQ2K12mwk0YdXUF2wZBTBA2kDZIk', bio: 'software engineer',posts_counter: 0)
    ...
    @user_three = User.create(name: 'Soe', photo: 'https://www.anisearch.de/images/character/cover/full/0/817.webp', bio: 'software engineer')
